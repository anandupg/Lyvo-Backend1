...
class NotificationService {
  ...
  static async notifyBookingApproval(booking, property, room, ownerId) {
    ...
    const notification = await this.createNotification({
      ...
      message: `Your booking for "${property.property_name}" has been approved! Please check in on the correct date. If you need to make changes, go to "My Bookings" and use the "Change Check-in" button.`,
      type: 'booking_approved',
      related_property_id: property._id,
      related_room_id: room?._id,
      related_booking_id: booking._id,
      action_url: `/seeker-bookings`,
      created_by: ownerId,
      metadata: {
        property_name: property.property_name,
        room_number: room?.room_number,
